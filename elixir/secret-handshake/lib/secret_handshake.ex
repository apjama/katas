defmodule SecretHandshake do
  # @lookup %{"1" => "wink", "10" => "double blink", "100" => "close your eyes", "1000" => "jump"}
  @doc """
  ...
  #   code_string = Integer.to_string(code, 2)
  #   found = Map.get(@lookup,  code_string)
  #   remainder = rem(code, 2)
  #
  #   case code do
  #     nil -> Enum.reverse(code_string)
  #     _ -> String.split(found, ",", parts: 1)
  #   end
  #
  # end
